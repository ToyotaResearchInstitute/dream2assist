...
export SDM_WS_DIR=$(dirname $(dirname $(dirname $(dirname $SCRIPT_DIR))))
...
source $SDM_WS_DIR/install/setup.bash
...
ros2 run shared_decision_making ua_shared_controller \
    ...
    --agent_path ~/sdm_demo/policies/epic_ai_leftright_carousel_straight_187/latest_model.pt \
    --dreamer_configs ~/sdm_ws/src/dream2assist/dream2assist/dream2assist/configs.yaml \
    --smoothen_actions \
    --smoothen_steps 5 \
